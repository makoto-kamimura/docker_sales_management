// 注文の制作・発送フロー (API の Order::STATUSES と対応。Web の lib/orderStatus.ts と同じ定義)
...
export const REQUEST_STATUS_LABEL: Record<string, string> = {
  pending: '受付待ち', answered: '回答済み', closed: '解決',
  quoted: '見積提示', in_progress: '制作中', completed: '完了', cancelled: 'キャンセル',
};
